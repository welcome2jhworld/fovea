...
Question set `questions.tune.json` (split tune): 17 answered, 0 skipped (video not provided). Index version `b63a3a358815`, google/siglip2-base-patch16-224 at revision `75de2d55ec2d`, 768 dims, one sample per 1000 ms. Search limit 50, min_gap_ms 3000, candidate_fraction 1; a hit overlaps ground truth by at least 1 s. Percentiles are interpolated between the neighbouring values, so the median of an even count is the midpoint of the two middle ones. Relevance is embedding similarity for ranking only, not verified. Platform darwin arm64.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| headline (not ambiguous) | 12 | 0.833 | 1.000 | 1.000 | 0.217 | 0.108 | 0.717 / 1.081 | 37.930 / 10.250 |
| ko | 5 | 0.600 | 1.000 | 1.000 | 0.200 | 0.100 | 0.717 / 3.916 | 31.520 / 32.170 |
| en | 7 | 1.000 | 1.000 | 1.000 | 0.229 | 0.114 | 0.717 / 0.001 | 32.713 / 4.770 |
| action | 3 | 0.667 | 1.000 | 1.000 | 0.200 | 0.100 | 19.800 / 10.800 | 24.200 / 39.293 |
| attribute | 2 | 0.500 | 1.000 | 1.000 | 0.200 | 0.100 | 12.530 / 1.080 | 21.994 / 1.944 |
| count | 2 | 1.000 | 1.000 | 1.000 | 0.300 | 0.150 | 22.256 / 2.208 | 39.518 / 3.974 |
| presence | 2 | 1.000 | 1.000 | 1.000 | 0.200 | 0.100 | 20.025 / 1.958 | 35.471 / 3.525 |
| scene | 3 | 1.000 | 1.000 | 1.000 | 0.200 | 0.100 | 0.700 / 0.000 | 0.714 / 0.001 |
| ambiguous | 1 | 1.000 | 1.000 | 1.000 | 0.200 | 0.100 | 42.833 / 4.416 | 42.833 / 4.416 |

Precision@K divides by K, and a query returned 6.0 ranges on average (6 at most), so P@10 is bounded by a tenth of the ranges returned rather than by how many of them are right.
...
| t005 | ko | presence | 주차장에 있는 사람 | 1 | 0.163 | lot-walking 0.67-53.92 s |
| t006 | en | presence | a bicycle in a crowded square | 1 | 0.156 | market-square 0.72-7.9 s |
| t007 | ko | attribute | 안경을 쓰고 남색 티셔츠를 입은 남자 | 2 | 0.081 | lot-walking 0.67-53.92 s |
| t008 | en | attribute | a white sports car | 1 | 0.114 | lot-whitecar 0.64-30.16 s |
| t009 | ko | attribute (ambiguous) | 민트색 자동차 | 1 | 0.130 | lot-walking 0.67-53.92 s |
| t010 | ko | action | 주차장을 가로질러 걸어가는 사람 | 1 | 0.177 | lot-walking 0.67-53.92 s |
| t011 | en | count | a cyclist and a car in the same parking lot | 1 | 0.205 | lot-walking 0.67-53.92 s |
| t012 | ko | action | 뒷줄에 앉아 있던 사람이 자리에서 일어나는 장면 | 3 | 0.098 | market-square 0.72-7.9 s |
...
| t015 | en | negative | a person riding a motorcycle | negative | 0.123 | lot-walking 0.67-53.92 s |
| t016 | en | negative | an empty classroom with nobody in it | negative | 0.113 | classroom 0.7-32.8 s |
| t017 | ko | negative | 비 오는 날 우산을 쓰고 걷는 사람 | negative | 0.130 | lot-walking 0.67-53.92 s |
